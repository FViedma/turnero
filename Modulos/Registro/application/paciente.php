        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Lista Pacientes</h2>
                </div>
                <!-- END PAGE TITLE -->                
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<?php 
											$ss = mysqli_query($connection,"SELECT * FROM paciente WHERE estado = 1;");
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?php echo $rr[1]; ?></td>
												<td><?php echo $rr[2].' '.$rr[3]; ?></td>
												<td><?php echo $rr[6]; ?></td>
												<td><?php echo $rr[5]; ?></td>
												<td><?php echo $rr[4]; ?></td>
												<td><?php echo $rr[7].' - '.$rr[8]; ?></td>
												<td>
													<a href="#a<?php echo $rr[0]; ?>" role="button" class="btn btn-success" data-toggle="modal"><i class="fa fa-pencil"></i></a>
													<a href="paciente.php?idborrar=<?php echo $rr[0]; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
												</td>
                                            </tr>
									    </tbody>
										<div id="a<?php echo $rr[0]; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										<form class="form-validate form-horizontal" name="form2" action="paciente.php" method="post">
											<input type="hidden" name="idpaciente" value="<?php echo $rr['idpaciente']; ?>">
													<div class="modal-dialog">
														<div class="modal-content">
															<div class="modal-header">
																<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
																<h3 id="myModalLabel" align="center">Cambiar informacion del Paciente</h3>
															</div>
															<div class="modal-body">
																<div class="row">
																	<div class="form-group">
																		  ...
																		  <div class="col-lg-9">
																			  <input class="form-control"  id="nombre" name="nombre" minlength="5" type="text" required value="<?php echo $rr[1]; ?>"/>
																		  </div>
																	  </div>
																	  
																	  <div class="form-group">
																		  <label for="apellido" class="control-label col-lg-3">Apellido Paterno:</label>
																		  <div class="col-lg-9">
																			  <input class="form-control"  id="apellido" name="apellido_pa" minlength="5" type="text" required value="<?php echo $rr[2]; ?>"/>
																		  </div>
																	  </div>
																	   <div class="form-group">
																		  <label for="apellido" class="control-label col-lg-3">Apellido Materno:</label>
																		  <div class="col-lg-9">
																			  <input class="form-control"  id="apellido" name="apellido_ma" minlength="5" type="text" required value="<?php echo $rr[3]; ?>"/>
																		  </div>
																	  </div>
																	  <div class="form-group">
																	  <label for="ci" class="control-label col-lg-3">CI:</label>
																	  <div class="col-lg-9">
																		  <input class="form-control"  id="ci" name="ci" minlength="5" type="text" required value="<?php echo $rr[6]; ?>"/>
																	  </div>
																	  </div>
																	  <div class="form-group">
																	  <label for="direccion" class="control-label col-lg-3">Direccion:</label>
																	  <div class="col-lg-9">
																		  <input class="form-control"  id="direccion" name="direccion" minlength="5" type="text" required value="<?php echo $rr[5]; ?>"/>
																	  </div>
																	  </div>
																	
																	<div class="form-group">
																	  <label for="telefonoFijo" class="control-label col-lg-3">Telefono:</label>
																	  <div class="col-lg-9">
																		  <input class="form-control"  id="telefonoFijo" name="telefonoFijo" minlength="5" type="text" required value="<?php echo $rr[7]; ?>"/>
																	  </div>
																	  </div>
																	  
																	  <div class="form-group">
																	  <label for="telefonoCelular" class="control-label col-lg-3">Celular:</label>
																	  <div class="col-lg-9">
																		  <input class="form-control"  id="telefonoCelular" name="telefonoCelular" minlength="5" type="text" required value="<?php echo $rr[8]; ?>"/>
																	  </div>
																	  </div>
																	  
																	  <div class="form-group">
																	  <label for="edad" class="control-label col-lg-3">edad:</label>
																	  <div class="col-lg-9">
																		  <input class="form-control"  id="edad" name="edad" type="text" required value="<?php echo $rr[4]; ?>"/>
																	  </div>
																	  </div>
															...
															<div class="modal-footer">
																...
																<button name="editar" type="submit" class="btn btn-primary"><strong>Editar</strong></button>
															</div>
															</div>
														</div>
													</div>
