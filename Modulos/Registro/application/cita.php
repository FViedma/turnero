	...
	if(isset($_POST['action']) or isset($_GET['view']))
	{
		...
		{   
			mysqli_query($connection,"INSERT INTO `cita` (
						...
						VALUES (
						'".mysqli_real_escape_string($connection,$_POST["idpaciente"])."',
						'".mysqli_real_escape_string($connection,$uid)."'
						'".mysqli_real_escape_string($connection,$_POST["id_cita"])."',
						'".mysqli_real_escape_string($connection,date('Y-m-d H:i:s',strtotime($_POST["inicio_cita"])))."',
						'".mysqli_real_escape_string($connection,date('Y-m-d H:i:s',strtotime($_POST["fin_cita"])))."',
						'".mysqli_real_escape_string($connection,$_POST["descripcion_cita`"])."'
						)");
			header('Content-Type: application/json');
						  ...
						  <div class="modal-body">
								<div class="control-group">
									...
									<div class="field desc">
										 <select class="form-control" name="idpaciente" id="title" required>
											<?php
												$c=mysqli_query($connection,"SELECT * FROM paciente ORDER by nombre ASC  ");
												while($d=mysqli_fetch_array($c)){
													echo '<option value="'.$d['idpaciente'].'">'.$d['nombre']." ".$d['ape_paterno'].'</option>';
												}
											?>
								...
								<div class="control-group">
									...
									<div class="field desc">
										<textarea class="form-control" id="descripcion_cita" name="descripcion_cita" placeholder="Descripcion" type="text" required></textarea>
									</div>
								</div>
								<hr>
