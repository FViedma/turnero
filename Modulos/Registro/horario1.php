                                                ...
                                                <style type="text/css">
                                                 ...
                                                 <td width="10%" heigth="10%">
                                                    ...
                                                    <div class="col-md-9">
                                                            ...
                                                            <input id="ini_lm" class="form-control" type="time" name="ini_lm" min="08:00" max="12:00"><span class="validity"></span>
                                                                                                
                                                    </div></td>
                                                    <td width="12%" heigth="10%">
                                                    <div class="col-md-3">
                                                        Fin: 
                                                    </div>
                                                    <div class="col-md-9">
                                                ...
                                                <td width="10%" heigth="10%">
                                                 ...
                                                 <td width="15%" heigth="10%">
                                                    ...
                                                    <div class="col-md-8">
                                                            ...
                                                            <input id="fin_mim" class="form-control" type="time" name="fin_min" min="08:00" max="12:00"><span class="validity"></span>
