    ...
    <div class="contenedor-principal">
        <div class="contenedor-info" id="info-roles">
            ...
            <form action="update_u.php" method="POST">
                ...
                <!--<input type="select" class="form-control mb-3" name="id_adm" placeholder="idCaja" value="<?php echo $row['idCaja']  ?>"><br></br>-->
                    ...
                    <select id="caja" name="caja">
                        ...
                        <?php
                            ...
                            while($caja=mysqli_fetch_assoc($buscar)){
								//echo "<option value='$caja[id]'>$caja[ventanilla]</option>";
                                echo "<option value='" . $caja['id'] . "'>" . $caja['ventanilla'] . "</option>";
                                echo "<td>" . $caja["id"] . "</td>";
							}
						?>
