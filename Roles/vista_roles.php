                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <th><a href="actualizar_r.php?id=<?php echo $row['id'] ?>" class="btn btn-info">Editar</a></th>
                                <th><a href="delete_r.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                             </tr>
                            <?php 
                            }
                            ?>
