                    ...
                    <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="Roles/actualizar_r.php?id=<?php echo $rol['id'] ?>" class="btn btn-info">Editar</a></td>
                                <td><a href="Roles/delete_r.php?id=<?php echo $rol['id'] ?>" class="btn btn-danger">Eliminar</a></td>                                        
                             </tr>
                            <?php 
                            }
                            ?>
